...
void eval()
{
    ...
    Z3_ast c1 = Z3_mk_fpa_gt(ctx, x, y);
    Z3_ast c2 = Z3_mk_eq(ctx, y, zero);
    /****************************/
    ...
    //Solve: x/y with x>y & y==0

    /* find model for the constraints above */
    if (Z3_solver_check(ctx, s) == Z3_L_TRUE) {
        
        Z3_symbol divisione_sym = Z3_mk_string_symbol(ctx, "x_div_y");
        Z3_ast x_div_y = Z3_mk_const(ctx, divisione_sym, FP_sort);
        Z3_ast eq = Z3_mk_fpa_div(ctx, rm, x, y);
